...
public abstract class SignatureUtil {
    private static Logger logger = LogManager.getLogger(SignatureUtil.class);
    ...
    public static void main(String[]args){
        ...
        String testString= SignatureUtil.sign(testss,"this is a test key!!!!");
        System.out.println("测试加密结果："+testString);
        if(SignatureUtil.valid(testss,"this is a test key!!!!",testString)){
