...
class DoubleSignature{
      ...
      public void GenerateSignature(String OI,String PI){
          String HOI=Signature.sign(OI,"test key");
          String HPI=Signature.sign(PI,"test key");
          String OP=HPI+HPI;
          String HOP=Signature.sign(OP,"test key");
          this.OI=OI;
          this.PI=PI;
          this.HPI=HPI;
          this.HOI=HOI;
      ...
      public static boolean CheckTheSignature(String HPart,String OPart,String HOP){
          String HOPart=Signature.sign(OPart,"test key");
          String OP=HOPart+HPart;
          String HOPGeted=Signature.sign(OP,"test key");
...
class DigitalEnvelope{
      ...
      public static Pair<String,String> encrypt(String plaintext,String publickey)throws Exception{
          ...
          String temproryKey = AES.getGUID();
          System.out.println("生成秘钥："+temproryKey);
          // 需要加密的字串
          System.out.println("明文:"+plaintext);
          // 对称加密
          String ciphertext = AES.Encrypt(plaintext,temproryKey);
          System.out.println("加密明文："+ciphertext);
          //非对称加密
          String ciphertemproryKey=RSA.Encrypy(temproryKey,publickey);//待实现
      ...
      public static void decrypt(String ciphertemproryKey,String ciphertext,String privatekey)throws Exception{
          // 解密
          String temproryKey=RSA.Decrypy(ciphertemproryKey,privatekey);//待实现
          System.out.println("解密后的密钥："+temproryKey);
          String DeString = AES.Decrypt(ciphertext, temproryKey);
      ...
      public static void main(String[]args)throws Exception{
          ca CA=new ca();
          CA.generateCA();
          mysqlmanipulate.AddItem("ca","info",CA.serial,CA.alg,CA.startdate,CA.enddate,CA.keypairs.getValue0(),CA.keypairs.getValue1());
          Pair<String,String> temp=mysqlmanipulate.QueryTable("3306","ca","info","root","25832233l","gM6NVM5lXDk6O3Nt");;
